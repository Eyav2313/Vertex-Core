...
Vertex is a Debian Stable derivative, not a generic respin. Debian provides the base operating system, security update cadence, package format, and initial root filesystem. Vertex owns the experience layer, system profiles, package selection, kernel policy, installation flow, and custom package repository.
